...
extension PortManagerFeatureStrings {
    ...
    static let ja = PortManagerFeatureStrings(title: "ポートマネージャー", filter: "ポート、プロセス、PIDで絞り込む", openFormat: "%d 個が開いています", empty: "待ち受けポートがありません", emptyHint: "更新するか検索条件を変更してください。", listeningCaption: "待ち受けポート", kill: "終了", forceKill: "強制終了", refresh: "更新", back: "戻る", terminateFormat: "%@を終了しますか？", terminateMessageFormat: "PID %2$dを終了してポート%1$dを閉じます。")
    ...
    static let zhHans = PortManagerFeatureStrings(title: "端口管理器", filter: "按端口、进程或 PID 筛选", openFormat: "%d 个开放", empty: "未找到监听端口", emptyHint: "尝试刷新或更改搜索条件。", listeningCaption: "监听端口", kill: "终止", forceKill: "强制终止", refresh: "刷新", back: "返回", terminateFormat: "要终止 %@ 吗？", terminateMessageFormat: "终止 PID %2$d 将关闭端口 %1$d。")
    static let zhTW = PortManagerFeatureStrings(title: "連接埠管理器", filter: "依連接埠、程序或 PID 篩選", openFormat: "%d 個開啟", empty: "找不到監聽中的連接埠", emptyHint: "請嘗試重新整理或變更搜尋條件。", listeningCaption: "監聽中的連接埠", kill: "結束", forceKill: "強制結束", refresh: "重新整理", back: "返回", terminateFormat: "要結束 %@ 嗎？", terminateMessageFormat: "結束 PID %2$d 將關閉連接埠 %1$d。")
    static let zhHK = PortManagerFeatureStrings(title: "連接埠管理員", filter: "按連接埠、程序或 PID 篩選", openFormat: "%d 個開啟", empty: "找不到監聽中的連接埠", emptyHint: "請嘗試重新整理或更改搜尋條件。", listeningCaption: "監聽中的連接埠", kill: "結束", forceKill: "強制結束", refresh: "重新整理", back: "返回", terminateFormat: "要結束 %@ 嗎？", terminateMessageFormat: "結束 PID %2$d 會關閉連接埠 %1$d。")
}
